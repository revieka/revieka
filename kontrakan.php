...
<html lang="en">
  ...
  <body>
    ...
    <?php 
include 'fun.php';
 $query = $conn->query("SELECT * FROM kontrakan WHERE categori = 1"); ?>
<?php while($a = $query->fetch_array()) {?>
	<div class="content mt-3 " style="background-color: grey;">
		<div class="col-sm-4  bt">

			 <div class="bt">
				<img  src="admin/assets/img/kost/kontrakan/<?= $a['foto'];?>" class="mt-3 bt"    width="300px" height="200px" /> <h5 class="card-title"><?= $a['nama_perumahan'];?></h5>
							   ...
							   <div class="card-text"  style="overflow: hidden; width:200px;hyphens: auto;height: 100px;">  <?= $a['deskripsi'];?>. </div>
							    <a  class="btn btn-success  as" href=" detail.php?id=<?= $a['perumhan_id'];?>"  >
                                     <a  class="btn btn-success  as" href=" detail.php?id=<?= $a['id_produk'];?>"  >
